...
PKG_NAME:=smartdns
PKG_VERSION:=2024.02.18
PKG_RELEASE:=1

PKG_SOURCE_PROTO:=git
PKG_SOURCE_URL:=https://github.com/pymumu/smartdns.git
PKG_SOURCE_VERSION:=53f57b74eac9dde4947ae7cbfa037869206bebd8
PKG_MIRROR_HASH:=ad03ffeceac52fb3ee2585a9dc491266d20d8520ea04b3e2487062614dc9991f
